...
//   const [eventName, setEventName] = useState('');
  ...
  const [events, setEvents] = useState([
    // Sample event data
    { id: 1, name: 'Chess Select Che', themeCost: 'Beginner', rating: 'Chennai', description: '' },
    { id: 1, name: 'Chess Select Cbe', themeCost: 'Beginner', rating: 'Coimbatore', description: '' },
    { id: 1, name: 'Chess Select Mad', themeCost: 'Beginner', rating: 'Madurai', description: '' },
    { id: 1, name: 'Chess Select The', themeCost: 'Beginner', rating: 'Theni', description: '' },
    { id: 1, name: 'Chess Select Tri', themeCost: 'Beginner', rating: 'Trichy', description: '' },
  ...
  const handleSearchSubmit = (e) => {
    ...
    return (
      ...
      <div className="be-none1">
        ...
        <h3>Oops! No Classes At This Places for Now...</h3>
